...
// Verification: getters resolved on the live UI carry `| verified: <date> <env>`; generated WITHOUT a DOM channel → `| PROVISIONAL — chưa xác minh trên UI thật` (run failures on those = locator debt, not app defects).
