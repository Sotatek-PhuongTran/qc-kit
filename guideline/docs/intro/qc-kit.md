...
**QC-kit** là một bộ công cụ AI agentic được thiết kế cho team **manual QC**. Nó không phải một ứng dụng cài-bấm-là-chạy, mà là một bộ tài sản (skills + rules + config + templates) được "nạp" vào một AI agentic tool (Claude Code, Antigravity, OpenAI Codex CLI...) để tool đó hiểu và thực hiện các tác vụ QC theo đúng quy trình team mong muốn.

<table data-view="cards"><thead><tr><th></th><th></th></tr></thead><tbody><tr><td><strong>Requirement documents</strong></td><td><ol><li>Common rules</li><li>UC specs</li><li>Wireframes/Design</li><li>API specs</li></ol><p></p></td></tr><tr><td><strong>QC-kit</strong></td><td>Skills + Rules<br>Templates<br>Config</td></tr><tr><td><strong>Output</strong></td><td><ol><li> Req review report</li><li>Test scenarios</li><li>Test cases</li></ol></td></tr></tbody></table>
...
Một feature CRUD đầy đủ thường ra 20-50 scenario, gấp 2\~3 lần khi viết tay.
