...
> - `qc-ui-extract` quản lý cột: `UI extract stt` (format `v<N> (audited v<M>)`, có thể append ` ⚠️ stale` khi audited bump v sau lần extract gần nhất).
...
| Site | Use Case ID | Module | Feature/Use case name | In scope? | Specs stt | WF stt | Test scenario stt | Test cases stt | UI extract stt | Execute stt |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
