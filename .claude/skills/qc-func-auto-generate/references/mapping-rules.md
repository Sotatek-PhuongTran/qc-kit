...
> Title: Auto-generate Mapping Rules | Created: 2026-07-02 | Updated: 2026-07-17 (v3 — B8: bỏ stamp chưa-xác-minh, page object chỉ sinh từ live crawl) | Author: Claude (QC Kit v3 rebuild) | Version: v3
...
- **Verification stamp per getter**: a locator resolved on the live UI is stamped `// verified: <date> <env>`. Page object CHỈ được sinh từ live crawl — không có channel thì dừng theo `references/dom-channels.md` ("If no channel is available": hướng dẫn user cài channel và CHỜ).
