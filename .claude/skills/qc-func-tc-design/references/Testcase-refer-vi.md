...
6. **Priority** theo thang Critical/High/Medium/Low (C6), gán theo ảnh hưởng nghiệp vụ × tần suất; ca bàn phím/zoom/refresh/UI tĩnh để **Low**.
...
| TC_090 | Kiểm tra thứ tự tiêu điểm khi nhấn Shift+Tab trên trang quên mật khẩu | Trang quên mật khẩu đang mở<br>Tiêu điểm đang ở `"Nút chính — Gửi liên kết đặt lại"` | 1. Nhấn phím Shift+Tab. | 1. Tiêu điểm lùi về `"Trường nhập email"` theo đúng thứ tự ngược; không thay đổi dữ liệu hay trạng thái nào trên trang. | Low |
...
| Kiểm tra Shift+Tab để High | Ca bàn phím/zoom/refresh không ảnh hưởng logic → **Low** |
